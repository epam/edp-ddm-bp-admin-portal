...
image::business-process-administration-portal.svg[]
...
[NOTE]
Більш детальніше ознайомитися зі стеком технологій можна xref:business-process-administration-portal:technologies.adoc[тут]
